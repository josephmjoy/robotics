...
## February 9, 2018B JMJ: Started work on rcping utility
...
arguments.  I considered various options for specifying message type and body,
here are some:
```
    -payload 'pos/x: 1 y: 2'
    -payload 'pos::x: 1 y: 2'
...
```
Currently, rcping just parses and prints the parse object.
