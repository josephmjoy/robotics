...
public class RobotComm implements AutoCloseable{
	...
	/**
	 * @param remote_port - port used for listening
	 * @param log - log to write internal logging and traces of messages.
	 */
	...
	/**
	 * Close any open underlying resources such as sockets. Will automatically get called by the 
	 */
	@Override
	public void close() {
	...
	/**
	 * Retrieves the next received message, if any. Returns null otherwise. Never blocks.
